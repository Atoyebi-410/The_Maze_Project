...
/**
 * initSDL - this initializes SDL, window, and renderer
...
/**
 * updateRenderer - this updates renderer with updated buffer / texture
 * @textured: True if user enabled textures, otherwise False
 * Return: void
 */
void updateRenderer(bool textured)
{
	int x, y; /* this loop counters */

	/* this draw buffer to renderer */
	if (textured)
	{
...
/**
 * closeSDL - this closes texture, renderer, and window
 * Return: void
 */
void closeSDL(void)
{
