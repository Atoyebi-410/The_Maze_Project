...
/**
 * loadTextures - this loads textures from file and puts pixel information in buffer
 * @mapName: name of map loaded
 * Return: void
 */
void loadTextures(char *mapName)
{
	SDL_Surface *texSrc[TEX_COUNT]; /* this is array of loaded textures */
	uint8_t *pixel; /* this is the color value of pixel at given coordinate */
	int i, j, k; /* this loop counters */
	...
	/* this get colors from texture pixels and put in array */
