...
/**
 * parseMap - this parses 2D array from file to create maze
 * @filename: this is the name of file containing map information
 * @map: this is 2D array of map information
 * Return: pointer to 2D array containing map information
 */
int *parseMap(char *filename, int *map)
{
	FILE *fp;
	char row[MAP_WIDTH * 2]; /* multiplied by 2 to account for spaces in map file */
	char *number;
	int i, j;
